...
namespace Demo.Services.Contract
{
    public abstract class AbstractStandardServices : AbstractBaseService
    {
        ...
        public abstract SuccessResult<AbstractStandard> InsertUpdateStandards(AbstractStandard abstractStandard, IEnumerable<HttpPostedFileBase> news_Json, IEnumerable<HttpPostedFileBase> Live_Json = null, IEnumerable<HttpPostedFileBase> Demo_Json = null);
