...
namespace Demo.Controllers
{
    public class StandardController : BaseController
    {
        ...
        public ActionResult StandardAddEdit(Standard standard, IEnumerable<HttpPostedFileBase> news_Json, IEnumerable<HttpPostedFileBase> live_Json, IEnumerable<HttpPostedFileBase> demo_Json)
        {
            var user = abstractStandardServices.InsertUpdateStandards(standard, news_Json, live_Json, demo_Json);
            if (user.Code == 200)
            {
