...
namespace Demo.Controllers
{
    public class CustomersController : BaseController
    {
        ...
        public JsonResult BindCustomers([ModelBinder(typeof(DataTablesBinder))] IDataTablesRequest requestModel, string StartDate = "", string EndDate = "", int StandardId = 0, int IsBlock = 0, int IsDemo = 0, string GroupName = "", string Type = "", string City = "", string ExpiryStartDate = "", string ExpiryEndDate = "", string SchoolName = "")
        {
            try
            {
                int totalRecord = 0;
                ...
                var model = abstractCustomerServices.CustomerSelectAll(pageParam, Search, StartDate, EndDate, StandardId, IsBlock, IsDemo, GroupName, Type, City, ExpiryStartDate, ExpiryEndDate, SchoolName);
        ...
        public IList<SelectListItem> BindDemoDropdown()
        {
            List<SelectListItem> items = new List<SelectListItem>();
            items.Add(new SelectListItem() { Text = "Demo Version", Value = "1" });
        ...
        public JsonResult SendNotificationForAllCustomer(string StartDate = "", string EndDate = "", int StandardId = 0, int IsBlock = 0, int IsDemo = 0, string GroupName = "", string Type = "", string City = "", string ExpiryStartDate = "", string ExpiryEndDate = "", string SchoolName = "", string Message = "",string Title="")
        {
            PageParam pageParam = new PageParam();
            pageParam.Offset = 0;
            pageParam.Limit = 100000;
            var model = abstractCustomerServices.CustomerSelectAll(pageParam, "", StartDate, EndDate, StandardId, IsBlock, IsDemo, GroupName, Type, City, ExpiryStartDate, ExpiryEndDate, SchoolName);
            foreach (var item in model.Values)
            {
                if (item != null && item.DeviceToken != null && item.DeviceToken != "")
                {
