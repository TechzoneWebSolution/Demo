...
namespace Demo.Infrastructure
{
    public class Messages
    {
        ...
        public static string FlatAlreadyExists = "This flat is already exists.";
        public static string ConfirmDelete = "Are you sure you want to delete this Record?";
        public static string MeetingAttendeesAlreadyAdded = "Meeting Attendees Already added";
        public static string ConfirmPaymentChangeStatus = "Are you sure you want to confirm this status?";
        public static string ConfirmPaymentResponseChangeStatus = "Are you sure you want to confirm this status?";
        ...
        public static string PollOptionRestriction = "Only two options are valid for one Pole.";
        public static string RecordSavedSuccessfully = "Record saved successfully.";
        public static string OrganizationError = "Please Add Organization Details First.";
        ...
        public static string RecordNotDeleted = "Record is not deleted successfully because it refers to order.";
        ...
        public static string InvalidEmail = "We couldn't find a OptnBuy account associated with email address provided.";
        ...
        public static string AgendaExist = "Agenda for this meeting already exists. Please try with another title.";
        ...
        public static string AlreadyCouponNameExist = "This Coupon Name and Code is already exists.";
        ...
        public static string SmallSizeImage = "Image size must be greater or equal to 500px";
